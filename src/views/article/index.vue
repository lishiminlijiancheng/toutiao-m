    ...
    <div class="main-wrap">
      ...
      <div class="article-detail" v-else-if="article.title">
        ...
        <van-cell class="user-info" center :border="false">
          ...
          />
          <div slot="title" class="user-name">{{article.auth_name}}</div>
      ...
      <div class="error-wrap" v-else>
        ...
        <van-button class="retry-btn" @click="get_article">点击重试</van-button>
      </div>
      <!-- /加载失败：其它未知错误（例如网络原因或服务端异常） -->
    </div>
...
export default {
  ...
  methods: {
    async get_article(){
        try{
            this.loading = true
        const {data} = await getArticle({articleId:this.articleId})
